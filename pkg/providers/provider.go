...
type Provider interface {
	Name() string
	SetupAndValidateCreateCluster(ctx context.Context, managementCluster *types.Cluster, clusterSpec *cluster.Spec) error
	SetupAndValidateDeleteCluster(ctx context.Context, cluster *types.Cluster, clusterSpec *cluster.Spec) error
	SetupAndValidateUpgradeCluster(ctx context.Context, managementCluster *types.Cluster, clusterSpec *cluster.Spec, currentSpec *cluster.Spec) error
	...
	DeleteResources(ctx context.Context, managementCluster *types.Cluster, clusterSpec *cluster.Spec) error

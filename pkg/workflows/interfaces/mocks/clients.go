...
func (m *MockClusterManager) Upgrade(arg0 context.Context, arg1, arg2 *cluster.Spec) error {
	m.ctrl.T.Helper()
...
func (mr *MockClusterManagerMockRecorder) Upgrade(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upgrade", reflect.TypeOf((*MockClusterManager)(nil).Upgrade), arg0, arg1, arg2)
}
